...
class Test(unittest.TestCase):
    def test_get_steady_state(self):
        ...
        with self.assertRaises(ValueError) as context:
            res = sabs_pkpd.clamp_experiment.get_steady_state('not_sim', time_ss)
        ...
        with self.assertRaises(ValueError) as context:
            res = sabs_pkpd.clamp_experiment.get_steady_state(sabs_pkpd.constants.s, time_ss, data_exp='not_data_exp')

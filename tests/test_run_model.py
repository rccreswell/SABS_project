...
def test_simulate_data():
    ...
    data_exp.Add_fitting_instructions(fitted_params_annot, exp_cond_param_annot, sim_output_param_annot)

    out = sabs_pkpd.run_model.simulate_data(fitted_params_values, s, data_exp)
